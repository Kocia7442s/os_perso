...
-- Phase 2.1 — Instantanés mensuels de la valeur nette (1 par mois) pour la courbe d'évolution.
CREATE TABLE IF NOT EXISTS finance_networth_snapshots (
    id           INT UNSIGNED NOT NULL AUTO_INCREMENT,
    mois         CHAR(7)       NOT NULL,                 -- "AAAA-MM"
    valeur_nette DECIMAL(12,2) NOT NULL,
    actifs       DECIMAL(12,2) NOT NULL DEFAULT 0,
    dettes       DECIMAL(12,2) NOT NULL DEFAULT 0,
    created_at   TIMESTAMP     NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (id),
    UNIQUE KEY uniq_snapshot_mois (mois)                 -- 1 instantané par mois (upsert)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
